...
namespace К2 {
    ...
    public partial class Database1DataSet : global::System.Data.DataSet {
        ...
        public partial class ПользовательDataTable : global::System.Data.TypedTableBase<ПользовательRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public ПользовательRow AddПользовательRow(short Код_пользователя, string Имя_пользователя) {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public ПользовательRow FindByКод_пользователя(short Код_пользователя) {
            ...
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            private void InitClass() {
                this.columnКод_пользователя = new global::System.Data.DataColumn("Код_пользователя", typeof(short), null, global::System.Data.MappingType.Element);
                ...
                this.columnИмя_пользователя.MaxLength = 536870910;
            }
        ...
        public partial class ПользовательRow : global::System.Data.DataRow {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public short Код_пользователя {
                get {
                    return ((short)(this[this.tableПользователь.Код_пользователяColumn]));
                }
                set {
            ...
            public string Имя_пользователя {
                get {
                    try {
                        return ((string)(this[this.tableПользователь.Имя_пользователяColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("Значение для столбца \'Имя_пользователя\' в таблице \'Пользователь\' равно DBNull.", e);
                    }
                }
                set {
                    this[this.tableПользователь.Имя_пользователяColumn] = value;
                }
            }
            ...
            public bool IsИмя_пользователяNull() {
                return this.IsNull(this.tableПользователь.Имя_пользователяColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public void SetИмя_пользователяNull() {
                this[this.tableПользователь.Имя_пользователяColumn] = global::System.Convert.DBNull;
            }
        }
...
namespace К2.Database1DataSetTableAdapters {
    ...
    public partial class ПользовательTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM `Пользователь` WHERE ((`Код_пользователя` = ?))";
            this._adapter.DeleteCommand.CommandType = global::System.Data.CommandType.Text;
            this._adapter.DeleteCommand.Parameters.Add(new global::System.Data.OleDb.OleDbParameter("Original_Код_пользователя", global::System.Data.OleDb.OleDbType.SmallInt, 0, global::System.Data.ParameterDirection.Input, ((byte)(0)), ((byte)(0)), "Код_пользователя", global::System.Data.DataRowVersion.Original, false, null));
            this._adapter.InsertCommand = new global::System.Data.OleDb.OleDbCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = "INSERT INTO `Пользователь` (`Код_пользователя`, `Имя_пользователя`) VALUES (?, ?)" +
                "";
            this._adapter.InsertCommand.CommandType = global::System.Data.CommandType.Text;
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.OleDb.OleDbParameter("Код_пользователя", global::System.Data.OleDb.OleDbType.SmallInt, 0, global::System.Data.ParameterDirection.Input, ((byte)(0)), ((byte)(0)), "Код_пользователя", global::System.Data.DataRowVersion.Current, false, null));
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.OleDb.OleDbParameter("Имя_пользователя", global::System.Data.OleDb.OleDbType.LongVarWChar, 0, global::System.Data.ParameterDirection.Input, ((byte)(0)), ((byte)(0)), "Имя_пользователя", global::System.Data.DataRowVersion.Current, false, null));
            this._adapter.UpdateCommand = new global::System.Data.OleDb.OleDbCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = "UPDATE `Пользователь` SET `Код_пользователя` = ?, `Имя_пользователя` = ? WHERE ((" +
                "`Код_пользователя` = ?))";
            this._adapter.UpdateCommand.CommandType = global::System.Data.CommandType.Text;
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.OleDb.OleDbParameter("Код_пользователя", global::System.Data.OleDb.OleDbType.SmallInt, 0, global::System.Data.ParameterDirection.Input, ((byte)(0)), ((byte)(0)), "Код_пользователя", global::System.Data.DataRowVersion.Current, false, null));
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.OleDb.OleDbParameter("Имя_пользователя", global::System.Data.OleDb.OleDbType.LongVarWChar, 0, global::System.Data.ParameterDirection.Input, ((byte)(0)), ((byte)(0)), "Имя_пользователя", global::System.Data.DataRowVersion.Current, false, null));
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.OleDb.OleDbParameter("Original_Код_пользователя", global::System.Data.OleDb.OleDbType.SmallInt, 0, global::System.Data.ParameterDirection.Input, ((byte)(0)), ((byte)(0)), "Код_пользователя", global::System.Data.DataRowVersion.Original, false, null));
        }
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::К2.Properties.Settings.Default.Database1ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Код_пользователя, Имя_пользователя FROM Пользователь";
        ...
        public virtual int Delete(short Original_Код_пользователя) {
            this.Adapter.DeleteCommand.Parameters[0].Value = ((short)(Original_Код_пользователя));
        ...
        public virtual int Insert(short Код_пользователя, string Имя_пользователя) {
            this.Adapter.InsertCommand.Parameters[0].Value = ((short)(Код_пользователя));
            if ((Имя_пользователя == null)) {
                this.Adapter.InsertCommand.Parameters[1].Value = global::System.DBNull.Value;
            }
            else {
                this.Adapter.InsertCommand.Parameters[1].Value = ((string)(Имя_пользователя));
            }
        ...
        public virtual int Update(short Код_пользователя, string Имя_пользователя, short Original_Код_пользователя) {
            this.Adapter.UpdateCommand.Parameters[0].Value = ((short)(Код_пользователя));
            if ((Имя_пользователя == null)) {
                this.Adapter.UpdateCommand.Parameters[1].Value = global::System.DBNull.Value;
            }
            else {
                this.Adapter.UpdateCommand.Parameters[1].Value = ((string)(Имя_пользователя));
            }
            this.Adapter.UpdateCommand.Parameters[2].Value = ((short)(Original_Код_пользователя));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Имя_пользователя, short Original_Код_пользователя) {
            return this.Update(Original_Код_пользователя, Имя_пользователя, Original_Код_пользователя);
        }
    }
